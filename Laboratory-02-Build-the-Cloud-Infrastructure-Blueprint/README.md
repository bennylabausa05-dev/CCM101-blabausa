...
## Skills Learned
The ability to manage the a documentation report that helps a cloud infrastructure to identify cloud components through the used of Linux Environments.

## Challenges Encountered
The Challenges that I encountered is that I have struggled to compare the Three Cloud services provided because there is so much to read and its hard to jump on to other and comeback again to compare them.
